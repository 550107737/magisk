...
void thread_code(long arg)
{
  while (1)
  {
    int read_value, write_value = 2048; /* What value should write_value be? */
	...
	write_value=5*(temp)*4095/(360 * 10);
...
static int __init template_init(void)
{
  ...
  memSet = rtai_kmalloc(nam2num("shmem2"), sizeof(int));
